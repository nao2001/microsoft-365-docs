...
You can remove encryption that is accessible by your organization. This means any encryption that is applied by the organization or any mail thats is protected with encrypt-only restrictions.
